#!/usr/bin/env bash
# =============================================================================
# endeavouros.sh — Optimizaciones específicas para EndeavourOS
# =============================================================================
...
optimize_endeavouros() {
    print_step "Aplicando optimizaciones para EndeavourOS..."
...
PACMANEOF
    ...
    local optional=("eos-update-notifier" "reflector")
